...
def stack_sessions(sourcedata_dir,preproc_dir,participant,session_epochs,output_resolution):
    ...
    # TODO plot topomap here
    all_evoked = all_epochs.average()
    # times = np.arange(-0.1,1.3,0.1)
    # all_evoked.plot_topomap(times, ch_type='mag', time_unit='s', show=False, cmap='coolwarm', sensors=False, res=600, average=0.1, vlim=(-16*10**14, 16*10**14))
    # train_data = np.load('/home/songyonghao/Documents/Data/Things-MEG1/Preprocessed_data//meg_sub-02_train.pkl', allow_pickle=True)
    # plt.savefig('./pic/Journal/topo_ten_meg.jpg', dpi=300)
...
if __name__=='__main__':
    ...
    args.participant = 2
    args.bids_dir = '/home/songyonghao/Documents/Data/Things-MEG1'
